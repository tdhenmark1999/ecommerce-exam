...
export function BestServicesSection() {
  return (
    <section className="max-w-screen-1.5xl mx-auto px-10 py-10 md:px-0 md:py-20">
      <div className="flex flex-col space-y-10 md:space-y-20">
        <div className="flex flex-col space-y-[10px] text-center">
          ...
          <h1 className="text-2xl font-bold uppercase">The best services</h1>
        ...
        <div className="grid grid-cols-1 gap-[30px] md:grid-cols-3">
          <div className="mx-auto flex max-w-[315px] flex-col items-center space-y-5 px-10 py-[35px]">
            <svg
            ...
            <span className="text-center text-sm text-secondary-gray">
